package com.atguigu.gmall0919.common.constant;
...
public class GmallConstant {
    ...
    public static final String  ES_INDEX_ALERT="gmall0919_coupon_alert";
    public static final String  ES_INDEX_SALE="gmall0919_sale_detail";
